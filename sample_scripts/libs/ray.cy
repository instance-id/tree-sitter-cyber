...
func createLib():
  decls = []
  decls.append(os.CFunc{ sym: 'InitWindow', args: [#int, #int, #voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'WindowShouldClose', args: [], ret: #bool })
  decls.append(os.CFunc{ sym: 'CloseWindow', args: [], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'SetWindowState', args: [#uint], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ClearWindowState', args: [#uint], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ToggleFullscreen', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'MaximizeWindow', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'MinimizeWindow', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'RestoreWindow', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetWindowIcon', args: [Image], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetWindowIcons', args: [#voidPtr, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetWindowTitle', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetWindowPosition', args: [#int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetWindowMonitor', args: [#int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetWindowMinSize', args: [#int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetWindowSize', args: [#int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetWindowOpacity', args: [#float], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'SetClipboardText', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'GetClipboardText', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'EnableEventWaiting', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DisableEventWaiting', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SwapScreenBuffer', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'PollInputEvents', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'WaitTime', args: [#double], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ShowCursor', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'HideCursor', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'IsCursorHidden', args: [], ret: #bool })
  decls.append(os.CFunc{ sym: 'EnableCursor', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DisableCursor', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'IsCursorOnScreen', args: [], ret: #bool })
  decls.append(os.CFunc{ sym: 'ClearBackground', args: [Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'BeginDrawing', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'EndDrawing', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'BeginMode2D', args: [Camera2D], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'EndMode2D', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'BeginMode3D', args: [Camera3D], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'EndMode3D', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'BeginTextureMode', args: [RenderTexture], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'EndTextureMode', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'BeginShaderMode', args: [Shader], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'EndShaderMode', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'BeginBlendMode', args: [#int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'EndBlendMode', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'BeginScissorMode', args: [#int, #int, #int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'EndScissorMode', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'BeginVrStereoMode', args: [VrStereoConfig], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'EndVrStereoMode', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'LoadVrStereoConfig', args: [VrDeviceInfo], ret: VrStereoConfig })
  decls.append(os.CFunc{ sym: 'UnloadVrStereoConfig', args: [VrStereoConfig], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'SetShaderValue', args: [Shader, #int, #voidPtr, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetShaderValueV', args: [Shader, #int, #voidPtr, #int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetShaderValueMatrix', args: [Shader, #int, Matrix], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetShaderValueTexture', args: [Shader, #int, Texture], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadShader', args: [Shader], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'SetTargetFPS', args: [#int], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'SetRandomSeed', args: [#uint], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'TakeScreenshot', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetConfigFlags', args: [#uint], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetTraceLogLevel', args: [#int], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'MemFree', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'OpenURL', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetTraceLogCallback', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetLoadFileDataCallback', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetSaveFileDataCallback', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetLoadFileTextCallback', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetSaveFileTextCallback', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'LoadFileData', args: [#voidPtr, #voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadFileData', args: [#voidPtr], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadFileText', args: [#voidPtr], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadDirectoryFiles', args: [FilePathList], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'IsFileDropped', args: [], ret: #bool })
  decls.append(os.CFunc{ sym: 'LoadDroppedFiles', args: [], ret: FilePathList })
  decls.append(os.CFunc{ sym: 'UnloadDroppedFiles', args: [FilePathList], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'SetExitKey', args: [#int], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'SetMousePosition', args: [#int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetMouseOffset', args: [#int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetMouseScale', args: [#float, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'GetMouseWheelMove', args: [], ret: #float })
  decls.append(os.CFunc{ sym: 'GetMouseWheelMoveV', args: [], ret: Vector2 })
  decls.append(os.CFunc{ sym: 'SetMouseCursor', args: [#int], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'SetGesturesEnabled', args: [#uint], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UpdateCamera', args: [#voidPtr, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UpdateCameraPro', args: [#voidPtr, Vector3, Vector3, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetShapesTexture', args: [Texture, Rectangle], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawPixel', args: [#int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawPixelV', args: [Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawLine', args: [#int, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawLineV', args: [Vector2, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawLineEx', args: [Vector2, Vector2, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawLineBezier', args: [Vector2, Vector2, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawLineBezierQuad', args: [Vector2, Vector2, Vector2, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawLineBezierCubic', args: [Vector2, Vector2, Vector2, Vector2, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawLineStrip', args: [#voidPtr, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCircle', args: [#int, #int, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCircleSector', args: [Vector2, #float, #float, #float, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCircleSectorLines', args: [Vector2, #float, #float, #float, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCircleGradient', args: [#int, #int, #float, Color, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCircleV', args: [Vector2, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCircleLines', args: [#int, #int, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawEllipse', args: [#int, #int, #float, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawEllipseLines', args: [#int, #int, #float, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRing', args: [Vector2, #float, #float, #float, #float, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRingLines', args: [Vector2, #float, #float, #float, #float, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangle', args: [#int, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangleV', args: [Vector2, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangleRec', args: [Rectangle, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectanglePro', args: [Rectangle, Vector2, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangleGradientV', args: [#int, #int, #int, #int, Color, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangleGradientH', args: [#int, #int, #int, #int, Color, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangleGradientEx', args: [Rectangle, Color, Color, Color, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangleLines', args: [#int, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangleLinesEx', args: [Rectangle, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangleRounded', args: [Rectangle, #float, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRectangleRoundedLines', args: [Rectangle, #float, #int, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTriangle', args: [Vector2, Vector2, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTriangleLines', args: [Vector2, Vector2, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTriangleFan', args: [#voidPtr, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTriangleStrip', args: [#voidPtr, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawPoly', args: [Vector2, #int, #float, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawPolyLines', args: [Vector2, #int, #float, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawPolyLinesEx', args: [Vector2, #int, #float, #float, #float, Color], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadImage', args: [Image], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'ImageFormat', args: [#voidPtr, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageToPOT', args: [#voidPtr, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageCrop', args: [#voidPtr, Rectangle], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageAlphaCrop', args: [#voidPtr, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageAlphaClear', args: [#voidPtr, Color, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageAlphaMask', args: [#voidPtr, Image], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageAlphaPremultiply', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageBlurGaussian', args: [#voidPtr, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageResize', args: [#voidPtr, #int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageResizeNN', args: [#voidPtr, #int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageResizeCanvas', args: [#voidPtr, #int, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageMipmaps', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDither', args: [#voidPtr, #int, #int, #int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageFlipVertical', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageFlipHorizontal', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageRotateCW', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageRotateCCW', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageColorTint', args: [#voidPtr, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageColorInvert', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageColorGrayscale', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageColorContrast', args: [#voidPtr, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageColorBrightness', args: [#voidPtr, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageColorReplace', args: [#voidPtr, Color, Color], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadImageColors', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadImagePalette', args: [#voidPtr], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'ImageClearBackground', args: [#voidPtr, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawPixel', args: [#voidPtr, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawPixelV', args: [#voidPtr, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawLine', args: [#voidPtr, #int, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawLineV', args: [#voidPtr, Vector2, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawCircle', args: [#voidPtr, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawCircleV', args: [#voidPtr, Vector2, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawCircleLines', args: [#voidPtr, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawCircleLinesV', args: [#voidPtr, Vector2, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawRectangle', args: [#voidPtr, #int, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawRectangleV', args: [#voidPtr, Vector2, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawRectangleRec', args: [#voidPtr, Rectangle, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawRectangleLines', args: [#voidPtr, Rectangle, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDraw', args: [#voidPtr, Image, Rectangle, Rectangle, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawText', args: [#voidPtr, #voidPtr, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ImageDrawTextEx', args: [#voidPtr, Font, #voidPtr, Vector2, #float, #float, Color], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadTexture', args: [Texture], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'IsRenderTextureReady', args: [RenderTexture], ret: #bool })
  decls.append(os.CFunc{ sym: 'UnloadRenderTexture', args: [RenderTexture], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UpdateTexture', args: [Texture, #voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UpdateTextureRec', args: [Texture, Rectangle, #voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'GenTextureMipmaps', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetTextureFilter', args: [Texture, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetTextureWrap', args: [Texture, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTexture', args: [Texture, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTextureV', args: [Texture, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTextureEx', args: [Texture, Vector2, #float, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTextureRec', args: [Texture, Rectangle, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTexturePro', args: [Texture, Rectangle, Rectangle, Vector2, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTextureNPatch', args: [Texture, NPatchInfo, Rectangle, Vector2, #float, Color], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'SetPixelColor', args: [#voidPtr, Color, #int], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadFontData', args: [#voidPtr, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadFont', args: [Font], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ExportFontAsCode', args: [Font, #voidPtr], ret: #bool })
  decls.append(os.CFunc{ sym: 'DrawFPS', args: [#int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawText', args: [#voidPtr, #int, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTextEx', args: [Font, #voidPtr, Vector2, #float, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTextPro', args: [Font, #voidPtr, Vector2, Vector2, #float, #float, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTextCodepoint', args: [Font, #int, Vector2, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTextCodepoints', args: [Font, #voidPtr, #int, Vector2, #float, #float, Color], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadUTF8', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'LoadCodepoints', args: [#voidPtr, #voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadCodepoints', args: [#voidPtr], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'TextAppend', args: [#voidPtr, #voidPtr, #voidPtr], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'DrawLine3D', args: [Vector3, Vector3, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawPoint3D', args: [Vector3, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCircle3D', args: [Vector3, #float, Vector3, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTriangle3D', args: [Vector3, Vector3, Vector3, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawTriangleStrip3D', args: [#voidPtr, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCube', args: [Vector3, #float, #float, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCubeV', args: [Vector3, Vector3, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCubeWires', args: [Vector3, #float, #float, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCubeWiresV', args: [Vector3, Vector3, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawSphere', args: [Vector3, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawSphereEx', args: [Vector3, #float, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawSphereWires', args: [Vector3, #float, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCylinder', args: [Vector3, #float, #float, #float, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCylinderEx', args: [Vector3, Vector3, #float, #float, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCylinderWires', args: [Vector3, #float, #float, #float, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCylinderWiresEx', args: [Vector3, Vector3, #float, #float, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCapsule', args: [Vector3, Vector3, #float, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawCapsuleWires', args: [Vector3, Vector3, #float, #int, #int, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawPlane', args: [Vector3, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawRay', args: [Ray, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawGrid', args: [#int, #float], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadModel', args: [Model], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'GetModelBoundingBox', args: [Model], ret: BoundingBox })
  decls.append(os.CFunc{ sym: 'DrawModel', args: [Model, Vector3, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawModelEx', args: [Model, Vector3, Vector3, #float, Vector3, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawModelWires', args: [Model, Vector3, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawModelWiresEx', args: [Model, Vector3, Vector3, #float, Vector3, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawBoundingBox', args: [BoundingBox, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawBillboard', args: [Camera3D, Texture, Vector3, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawBillboardRec', args: [Camera3D, Texture, Rectangle, Vector3, Vector2, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawBillboardPro', args: [Camera3D, Texture, Rectangle, Vector3, Vector3, Vector2, Vector2, #float, Color], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UploadMesh', args: [#voidPtr, #bool], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UpdateMeshBuffer', args: [Mesh, #int, #voidPtr, #int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadMesh', args: [Mesh], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawMesh', args: [Mesh, Material, Matrix], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DrawMeshInstanced', args: [Mesh, Material, #voidPtr, #int], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'GenMeshTangents', args: [#voidPtr], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadMaterial', args: [Material], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetMaterialTexture', args: [#voidPtr, #int, Texture], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetModelMeshMaterial', args: [#voidPtr, #int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'LoadModelAnimations', args: [#voidPtr, #voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UpdateModelAnimation', args: [Model, ModelAnimation, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadModelAnimation', args: [ModelAnimation], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadModelAnimations', args: [#voidPtr, #uint], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'InitAudioDevice', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'CloseAudioDevice', args: [], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'IsAudioDeviceReady', args: [], ret: #bool })
  decls.append(os.CFunc{ sym: 'SetMasterVolume', args: [#float], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UpdateSound', args: [Sound, #voidPtr, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadWave', args: [Wave], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadSound', args: [Sound], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'PlaySound', args: [Sound], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'StopSound', args: [Sound], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'PauseSound', args: [Sound], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ResumeSound', args: [Sound], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'IsSoundPlaying', args: [Sound], ret: #bool })
  decls.append(os.CFunc{ sym: 'SetSoundVolume', args: [Sound, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetSoundPitch', args: [Sound, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetSoundPan', args: [Sound, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'WaveCopy', args: [Wave], ret: Wave })
  decls.append(os.CFunc{ sym: 'WaveCrop', args: [#voidPtr, #int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'WaveFormat', args: [#voidPtr, #int, #int, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'LoadWaveSamples', args: [Wave], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UnloadWaveSamples', args: [#voidPtr], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadMusicStream', args: [Music], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'PlayMusicStream', args: [Music], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'IsMusicStreamPlaying', args: [Music], ret: #bool })
  decls.append(os.CFunc{ sym: 'UpdateMusicStream', args: [Music], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'StopMusicStream', args: [Music], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'PauseMusicStream', args: [Music], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ResumeMusicStream', args: [Music], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SeekMusicStream', args: [Music, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetMusicVolume', args: [Music, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetMusicPitch', args: [Music, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetMusicPan', args: [Music, #float], ret: #voidPtr })
  ...
  decls.append(os.CFunc{ sym: 'UnloadAudioStream', args: [AudioStream], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'UpdateAudioStream', args: [AudioStream, #voidPtr, #int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'IsAudioStreamProcessed', args: [AudioStream], ret: #bool })
  decls.append(os.CFunc{ sym: 'PlayAudioStream', args: [AudioStream], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'PauseAudioStream', args: [AudioStream], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'ResumeAudioStream', args: [AudioStream], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'IsAudioStreamPlaying', args: [AudioStream], ret: #bool })
  decls.append(os.CFunc{ sym: 'StopAudioStream', args: [AudioStream], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetAudioStreamVolume', args: [AudioStream, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetAudioStreamPitch', args: [AudioStream, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetAudioStreamPan', args: [AudioStream, #float], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetAudioStreamBufferSizeDefault', args: [#int], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'SetAudioStreamCallback', args: [AudioStream, #voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'AttachAudioStreamProcessor', args: [AudioStream, #voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DetachAudioStreamProcessor', args: [AudioStream, #voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'AttachAudioMixedProcessor', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CFunc{ sym: 'DetachAudioMixedProcessor', args: [#voidPtr], ret: #voidPtr })
  decls.append(os.CStruct{ fields: [], type: Music })
  decls.append(os.CStruct{ fields: [], type: Camera2D })
  decls.append(os.CStruct{ fields: [], type: RenderTexture })
  decls.append(os.CStruct{ fields: [], type: VrStereoConfig })
  decls.append(os.CStruct{ fields: [], type: VrDeviceInfo })
  decls.append(os.CStruct{ fields: [], type: Color })
  decls.append(os.CStruct{ fields: [], type: Texture })
  decls.append(os.CStruct{ fields: [], type: Transform })
  decls.append(os.CStruct{ fields: [], type: Camera3D })
  decls.append(os.CStruct{ fields: [], type: Model })
  decls.append(os.CStruct{ fields: [], type: RayCollision })
  decls.append(os.CStruct{ fields: [], type: BoundingBox })
  decls.append(os.CStruct{ fields: [], type: Sound })
  decls.append(os.CStruct{ fields: [], type: Vector4 })
  decls.append(os.CStruct{ fields: [], type: ModelAnimation })
  decls.append(os.CStruct{ fields: [], type: Rectangle })
  decls.append(os.CStruct{ fields: [], type: Image })
  decls.append(os.CStruct{ fields: [], type: BoneInfo })
  decls.append(os.CStruct{ fields: [], type: Material })
  decls.append(os.CStruct{ fields: [], type: NPatchInfo })
  decls.append(os.CStruct{ fields: [], type: Font })
  decls.append(os.CStruct{ fields: [], type: Wave })
  decls.append(os.CStruct{ fields: [], type: AudioStream })
  decls.append(os.CStruct{ fields: [], type: Vector3 })
  decls.append(os.CStruct{ fields: [], type: Vector2 })
  decls.append(os.CStruct{ fields: [], type: Matrix })
  decls.append(os.CStruct{ fields: [], type: Mesh })
  decls.append(os.CStruct{ fields: [], type: Shader })
  decls.append(os.CStruct{ fields: [], type: GlyphInfo })
  decls.append(os.CStruct{ fields: [], type: Ray })
  decls.append(os.CStruct{ fields: [], type: FilePathList })
  decls.append(os.CStruct{ fields: [], type: MaterialMap })
  return os.bindLib('../ray-cyber/libraylib.4.5.0.dylib', decls, { genMap: true })
